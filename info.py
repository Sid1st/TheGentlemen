...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002249081198')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002151777689')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002182741200', '-1002219778296')).split()]
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movies_request_group_2024')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MoviesXonee')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movies_request_group_2024') # Support Chat Link Without https:// or @
...
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "[TG - @MoviesXonee]")
